...
type: specification
created_date: '2026-08-14 16:54'
updated_date: '2026-08-17 07:57'
---
> **Imported verbatim from `~/repos/agent-fanout-generic.md` on 2026-08-14.** This in-repo copy is
> authoritative for this repository. The source is a loose, unversioned file on one machine; a
> tracked copy makes the checkout self-contained, so an agent in CI or on another machine has the
> whole model. Do not summarise, compress or excerpt it. When the source changes, re-import here in
> the same change.
