...
## [0.8.0](https://github.com/rknightion/sagemcom-f3896-py/compare/v0.7.0...v0.8.0) (2026-09-26)
...
* adopt canonical routing and bounded root rescue ([54cbcc0](https://github.com/rknightion/sagemcom-f3896-py/commit/54cbcc0bebb990bb098e3115d275de33ceb7e6f3))
* **agents:** review fix sagemcom-f3896-py AGENTS.md ([ea6d063](https://github.com/rknightion/sagemcom-f3896-py/commit/ea6d06343ee6c07b9cab0864846e79ebd57ee53b))
* **agents:** sagemcom-f3896-py to AGENTS.md standard ([d6d392d](https://github.com/rknightion/sagemcom-f3896-py/commit/d6d392d662f5475a46dae36702e13631ac4b68ad))
* align recovery contracts and compaction evidence ([9b271ba](https://github.com/rknightion/sagemcom-f3896-py/commit/9b271ba289415ad5290e6a5746e26cca36f4d846))
...
* publish canonical agent documents ([3b33b6f](https://github.com/rknightion/sagemcom-f3896-py/commit/3b33b6fcd03b1de1900b01891a33b0d98e106613))
* publish canonical agent documents ([1ae1ac7](https://github.com/rknightion/sagemcom-f3896-py/commit/1ae1ac7e07a93f1db3461a555dcd42d4761c02a2))
* publish canonical agent documents ([683baf2](https://github.com/rknightion/sagemcom-f3896-py/commit/683baf2591a4ca0dd5d3015be496a9472d358b6a))
* publish canonical agent documents ([56ac5bb](https://github.com/rknightion/sagemcom-f3896-py/commit/56ac5bbab3e4c5aa06777a32a5716c78171d35c3))
* publish canonical agent documents ([519db20](https://github.com/rknightion/sagemcom-f3896-py/commit/519db20de86f4a1ea36b6b35c08961ec9f7dbe6f))
* publish canonical agent documents ([0836eb1](https://github.com/rknightion/sagemcom-f3896-py/commit/0836eb1fcc1c7a8677fec2bc6f02062911026297))
* publish canonical agent documents ([ae3a3ba](https://github.com/rknightion/sagemcom-f3896-py/commit/ae3a3ba3e8897c58d32a1a8959e60abeda3b9e20))
* publish canonical agent documents ([4879da6](https://github.com/rknightion/sagemcom-f3896-py/commit/4879da69e972417576dff5fd5478bc1445203530))
* publish canonical agent documents ([f2717ea](https://github.com/rknightion/sagemcom-f3896-py/commit/f2717ea1dd13a912083f39c67cb6065d0aab93dc))
* publish canonical agent documents ([7340aff](https://github.com/rknightion/sagemcom-f3896-py/commit/7340aff64ca448762556159e564268f70b42f103))
* publish canonical agent documents ([dd9fa4a](https://github.com/rknightion/sagemcom-f3896-py/commit/dd9fa4ad5b5e9c92ed17e5d619cde4879d37cf85))
* publish canonical agent documents ([ea57db7](https://github.com/rknightion/sagemcom-f3896-py/commit/ea57db7a984f62b4f53cf2e13185902f3648fb5c))
* publish canonical agent documents ([8c2d7a3](https://github.com/rknightion/sagemcom-f3896-py/commit/8c2d7a3269e4f93b4f334ca3ddcd4107cad2bf10))
* publish canonical agent documents ([1e27d98](https://github.com/rknightion/sagemcom-f3896-py/commit/1e27d98c3de31b50be23bf6da00f568a021ac316))
* publish canonical agent documents ([b40038a](https://github.com/rknightion/sagemcom-f3896-py/commit/b40038ae9d3be7174be1d5a2411b5565bd6e6174))
* publish canonical agent documents ([7dcebe7](https://github.com/rknightion/sagemcom-f3896-py/commit/7dcebe714838ca5a8f2f9247519e70db64609de5))
* publish canonical agent documents ([cdb4b40](https://github.com/rknightion/sagemcom-f3896-py/commit/cdb4b40aa890709ddaab1978ba0f620f6754811d))
...
* sync approved fan-out scheduling and route verification ([d06a9c6](https://github.com/rknightion/sagemcom-f3896-py/commit/d06a9c659728d01d243df221ec8fa829aa586b0e))
...
* sync authorised Astra root judgement ([795de5b](https://github.com/rknightion/sagemcom-f3896-py/commit/795de5bfdf4a8072e58c91e9da9be8cecd9cfe55))
* sync authorised Astra root judgement ([cc18f6f](https://github.com/rknightion/sagemcom-f3896-py/commit/cc18f6f9c6d3ec5ac2d3a0242474739b3d4dec08))
* sync cost-aware fan-out routing and prompt guidance ([71a24cd](https://github.com/rknightion/sagemcom-f3896-py/commit/71a24cd68ad0ff53ad9f2a5201b45c7d1febc3d8))
* sync fan-out async decision-only guidance ([d49fb6f](https://github.com/rknightion/sagemcom-f3896-py/commit/d49fb6f5d58833d98a808be528ca2e84f1619d67))
* sync fan-out protocol from agent-docs ad7abd2 ([8cbfc07](https://github.com/rknightion/sagemcom-f3896-py/commit/8cbfc077d7a0cfea0beb2e6e49c345a1c21dae83))
* sync fan-out protocol, delegated root authority for unattended runs ([57fc72b](https://github.com/rknightion/sagemcom-f3896-py/commit/57fc72b106b46f8c3269ce7cc623c1ab5f63e8cd))
* sync fan-out protocol, explicit add does not bound the commit ([fc1c4f3](https://github.com/rknightion/sagemcom-f3896-py/commit/fc1c4f371e035c5d973c408f28683e774acb090e))
* sync fixed Astra low orchestration and rescue routing ([8574ca5](https://github.com/rknightion/sagemcom-f3896-py/commit/8574ca5e058856dd19bcf1f8b0a7be398ed54a8e))
...
* sync polling and integration contracts ([a19e85c](https://github.com/rknightion/sagemcom-f3896-py/commit/a19e85cad5403a48571cd5540326323b56db121a))
* sync root async question policy ([5d98b1c](https://github.com/rknightion/sagemcom-f3896-py/commit/5d98b1cdb2484683f2544f951964a8fee4f7c748))
* sync same-session fan-out recovery contract ([99444af](https://github.com/rknightion/sagemcom-f3896-py/commit/99444af9b2b22a2d4b6b7e0a2aade57fb55c9cc6))
* sync wave orchestration and existing-root contracts ([4808751](https://github.com/rknightion/sagemcom-f3896-py/commit/4808751c21637edcffdf545d2d849d9d44650579))
* sync wave reliability and worktree contracts ([04401b2](https://github.com/rknightion/sagemcom-f3896-py/commit/04401b2ca74cd10aaaf5bf3e5675760e4bf855b1))
